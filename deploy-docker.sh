...
show_info() {
    ...
    echo -e "  - ${YELLOW}Admin (Toàn quyền):${NC}           admin / 123456"
    echo -e "  - ${YELLOW}Sales (Bán hàng):${NC}             sales / 123456"
    echo -e "  - ${YELLOW}Purchasing (Mua hàng):${NC}        purchasing / 123456"
    echo -e "  - ${YELLOW}Warehouse (Thủ kho):${NC}          warehouse / 123456"
    echo -e "  - ${YELLOW}Accountant (Kế toán nợ):${NC}      accountant / 123456"
    echo ""
